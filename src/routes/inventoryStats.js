...
const webpackEnsure = (store, cb) => {
  ...
  require.ensure([], (require) => {
    ...
    let inventoryStats = require('containers/inventoryStats/statsContainer').default

    let inventoryStatsReducer = require('containers/inventoryStats/statsModule').default
